...
})(["position:absolute;top:0;right:0;left:0;height:64px;background:#fff;padding:0 48px;box-sizing:border-box;display:flex;align-items:center;justify-content:space-between;font-weight:bold;& a{display:inline-flex;height:48px;background:#f94343;color:#fff;text-decoration:none;font-weight:bold;border-radius:4px;align-items:center;justify-content:center;padding:0 16px;}"]);
...
//# sourceMappingURL=xoh.js.148a7bb082829a3b8b3e.hot-update.js.map